...
//Created by ditzel , youtube : https://www.youtube.com/@DitzelGames , Github : https://gist.github.com/ditzel
...
public class MeshDestroy : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Specifies how long the destroyed fragments will take to fade")]
    ...
    public class PartMesh
    {
        ...
        {
            //if (Vertices.Length <= 100) return; //Added this so we dont have meshes with 
            ...
            meshDestroy._maxDestroyLevel = original._maxDestroyLevel;
            meshDestroy._destroyTime = original._destroyTime;
